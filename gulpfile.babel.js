    ...
    app: {
      ...
      scripts: {
        ...
        libs: [
          ...
          './app/js/lib/add-to-cart.min.js',
          './app/js/lib/scripts.js',
          './app/js/lib/js.cookie.min.js',
          './app/js/lib/cart-fragments.min.js',
          './app/js/lib/swiper.min.js',
          './app/js/lib/jquery.fancybox.min.js',
          './app/js/lib/isotope.pkgd.min.js',
          ...
          './app/js/lib/before-after.min.js',
          './app/js/lib/comment-reply.min.js',
          './app/js/lib/js_composer_front.min.js',
        ]
      },
      images: {
        root: './app/img/',
